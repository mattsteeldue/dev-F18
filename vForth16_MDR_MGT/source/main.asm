...
//  The binary-code "forth16.by" has to be manually copied to microdrive cartridge
//  via "F16.tap" tape file which contains such a binary file.
//  I'm using Z80 the Sinclair ZX Spectrum 48/128K Emulator Version 4.00 by Gerton Lunter 1999
//  ______________________________________________________________________
// 
...
//  ______________________________________________________________________
                ...
                if ( -1 == DEBUGGING ) 
ORIGIN          equ    41980 - $80                    // for binary comparison
//ORIGIN          equ     $8CC1                   // for binary comparison
                endif
//  ______________________________________________________________________

                if (  0 == DEBUGGING ) 
ORIGIN          equ     $6400                   // binary and Tape
                endif
//  ______________________________________________________________________
...
//              SAVEBIN "output/ram2.bin", $8000, 9800 ;- save 3000h begin from 8000h of RAM to file 
                ...
                SAVETAP "output/F16m.tap", CODE, "forth16.by", ORIGIN, 9100

                SAVEBIN "output/forth16.by", ORIGIN, 9100
