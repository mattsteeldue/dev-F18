...
// cold         --
                ...
                dw      NOOP, NOOP              // To intercept COLD start, useful for ZAP!
...
//              nop
                ld      (SP_Basic),hl           // but also save Forth's 
                exx
                pop     hl                      // restore h'l'
                exx
...
//
// stream
                Variable_Def STRM,   "STRM",   4

//  ______________________________________________________________________ 
//
// driver number
                Variable_Def DRV,   "DRV",   0

//  ______________________________________________________________________ 
//
// microdrive map address
