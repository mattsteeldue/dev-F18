...
// marker       -- cccc
                ...
                dw      LATEST, COMMA
// heap         dw      CURRENT, FETCH, FETCH, COMMA
...
// special utility to rename a word to another name but same length
                ...
                dw BL, WORD
                dw LIT, $20, ALLOT              // bl word       [ hex 20 ] Literal  allot
                dw COUNT, LIT, $1F
                dw AND_OP, ROT, MIN             // count  [ hex 1F ] Literal  and rot min
                dw TO_R                         // >r 
                dw SWAP, ONE_PLUS               // swap 1+
                dw R_TO                         // r>
                dw CMOVE                        // cmove
                dw R_OP, CFETCH                 // r  c@  [ hex 80 ] Literal  or
                dw LIT, $80, OR_OP                  
                dw R_TO                         // r>      
                dw CSTORE                       // c!
                dw LIT, $-20, ALLOT             // [ hex -20 ] Literal allot
                dw EXIT
...
Backslash_Else_1:
                            // 0 tib @ >in @ + !
                            // trick: put a zeroes at this TIB position 
                            // so that it's interpreted as end-of-text
