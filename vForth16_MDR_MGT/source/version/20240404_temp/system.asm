...
DF_SZ           equ     $5C6B                   // Size in rows of Lower part of Screen
STRMS           equ     $5C16                   // Streams  address
CHANS           equ     $5C4F                   // Channels address 
...
S0_system:      equ     $D0E8 + $1f58              // Address of top of Calc Stack
TIB_system      equ     $D0E8 + $1f58              // TIB grows upwards, Return-Stack downward.
R0_system:      equ     $D188 + $1f58              // Address of top of Return Stack. This is S0 + $00A0
USER_system:    equ     $D188 + $1f58              // User variables zone.
FIRST_system:   equ     $D1E4 + $1f58              // Address of first BUFFER
LIMIT_system:   equ     $E000 + $1f58              // Address of first byte beyond last BUFFER
