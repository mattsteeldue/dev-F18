\ ZX Next Sprite lib v0.1 ported from Boriel ZX BASIC nextlib.bas
...
: init-sprite ( spriteid --- )
  ...
  ZXN-SPRITE-SLOT-SELECT-PORT SWAP P!           \ Set sprite slot spriteid via ZXN Port $303B
...
: load-init-sprites ( num fname --- addr )
  ...
  [ 0 ] LITERAL DO                              \ num limit already on stack
