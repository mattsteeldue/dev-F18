...
// otherwise, it forces channel+13 "CHREC" and calls MDRGET
                ...
                dw      MGT, FETCH, TWO_DIV          // MGT @ 2/                           // DR0 correction
...
// somehow, it needs a CAT 2 from Basic, first.
                ...
                ld      a, 2                    // Drive number
                pop     hl                      // D=track E=sector (hl)
                ex      (sp), ix                // Buffer Address
                push    bc
                push    de
                ex      de, hl
                rst     08
