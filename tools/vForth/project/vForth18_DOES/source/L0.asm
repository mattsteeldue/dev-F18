...
Splash_Ptr      defl    $ - $E000           // save current HP                
                ...
                db      " Heap Vocabulary - build 2026-07-26 ", $0D  // 37
...
s                exx                         // restore a1/a2;  Z survives a exx
...
// Let' use stack instead of the following variable.
...
//
//                New_Def CURS, "CURS", is_code, is_normal
//  
//                push    bc                  // save Instruction Pointer
